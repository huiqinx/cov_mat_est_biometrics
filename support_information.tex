...
\usepackage{graphicx, amsmath, chngcntr, setspace, caption, subcaption, float,multirow, longtable, booktabs, graphicx, lscape, rotating, amssymb, amsfonts}
%\usepackage{geometry}
...
\multirow{5}{*}{Dense-0.7}     & Exemplar & 3.76 (3.81) & 12.38 (13.37) & 19.93 (21.49) \\
...
\multirow{5}{*}{Dense-0.9}     & Exemplar & 4.46 (5.23) & 14.63 (21.61) & 24.35 (37.1)  \\
...
\multirow{10}{*}{Sparse}   
 ...
 & QIS            & 4.81 (1.34) & 14.49 (1.15) & 26.77 (1.11) \\
...
\multirow{10}{*}{Hypercorrelated}  
 ...
 & QIS            & 7.33 (4.14) & 24.04 (12.94) & 47.96 (26.64)   \\
...
\multirow{10}{*}{Sparse}    
 ...
 & QIS            & 2.30 (0.34) & 7.68 (0.37)  & 14.40 (0.36) \\
...
\multirow{10}{*}{Hypercorrelated}    
 ...
 & QIS            & 1.75 (0.61) & 5.68 (1.61)  & 11.14 (2.94) \\
...
\multirow{10}{*}{Sparse}    
 ...
 & QIS            & 4.67 (1.37) & 14.45 (1.25) & 26.72 (1.15) \\
...
\multirow{10}{*}{Hypercorrelated}    
 ...
 & QIS            & 6.73 (2.90)  & 20.21 (10.45) & 41.69 (21.84)  \\
...
\multirow{10}{*}{Sparse}    
 ...
 & QIS            & 4.70 (1.17) & 14.60 (1.17) & 26.99 (1.05)  \\
...
\multirow{10}{*}{Hypercorrelated}    
 ...
 & QIS            & 7.71 (4.95)  & 24.20 (17.19) & 49.38 (30.91)   \\
...
\toprule
 ...
 & QIS            	&98.54(0.69) 	&270.95(181.24) 	&173.91(120.91)	&162.85(133.79) 	&27.86(0.09) 	&4.19(0.16) \\
...
=\hat{\mu}\frac{\bar{b}_n^2}{d_n^2},
\end{align*}
where $\bar{b}_n^2 = \frac{1}{n^2}\|\bs{X}_i\bs{X}_i^\top-\bs{S}\|_F^2 = \sum_{j,k=1}^p\hat\Delta_{jk}^2/p$.

Thus by the definition that $b_n^2 = \min\{\bar{b}_n^2,d_n^2\}$, $\min(\hat{\mu}, \hat{\beta}_I) = \hat{\mu} b_n^2 / d_n^2$, which is the coefficient of the second term in the Ledoit and Wolf estimator \eqref{eq:lw}. Furthermore,
\begin{align*}
